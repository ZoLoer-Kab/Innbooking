<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="report_cha2.aspx.cs" Inherits="WebF.report_cha2" %>
...
<section id="user-details" class="mmb-panel" data-selenium="mmb-user-details-panel">
    <h1 data-selenium="mmb-user-details-panel-title">訂單詳細資料</h1>
    ...
    <div id="mmb-email-component-display" class="mmb-email-not-verified-component">
        <div id="mmb-email-component-display-email" class="mmb-notification-component">
            <div>
                <h2 data-selenium="mmb-email-component-display-email-label">訂單編號</h2>              
            </div>
            <div id="mmb-email-component-verify-box" class="mmb-verify-box ">     
            <span id="mmb-email-component-display-email-value" data-selenium="mmb-email-component-display-email-value"><asp:Label ID="customter" runat="server" Text="Label"></asp:Label></span>
                 </div>
        </div>
    </div>   
</section>
...
<section id="mmb-phone-component" class="mmb-component" data-selenium="mmb-phone-component">
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">房間編號</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="ROOM_ID1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">訂單日期</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="Orderdate1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    <div id="mmb-phone-component-change" data-selenium="mmb-phone-component-change">                 
    </div>    
    <div id="mmb-phone-component-otp-verification" data-selenium="mmb-phone-component-otp-verification">     
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">開始日期</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="Startdate1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    <div id="mmb-phone-component-change" data-selenium="mmb-phone-component-change">                 
    </div>    
    <div id="mmb-phone-component-otp-verification" data-selenium="mmb-phone-component-otp-verification">     
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">結束日期</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="enddate1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    <div id="mmb-phone-component-change" data-selenium="mmb-phone-component-change">                 
    </div>    
    <div id="mmb-phone-component-otp-verification" data-selenium="mmb-phone-component-otp-verification">     
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">食物</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="food1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    <div id="mmb-phone-component-change" data-selenium="mmb-phone-component-change">                 
    </div>    
    <div id="mmb-phone-component-otp-verification" data-selenium="mmb-phone-component-otp-verification">     
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">床</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="bed1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    <div id="mmb-phone-component-change" data-selenium="mmb-phone-component-change">                 
    </div>    
    <div id="mmb-phone-component-otp-verification" data-selenium="mmb-phone-component-otp-verification">     
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">總價</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="Totalprice1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    <div id="mmb-phone-component-change" data-selenium="mmb-phone-component-change">                 
    </div>    
    <div id="mmb-phone-component-otp-verification" data-selenium="mmb-phone-component-otp-verification">     
    ...
    <div id="mmb-phone-component-display" class="mmb-phone-verified-component">
        <div id="mmb-phone-component-display-phone" class="mmb-notification-component">
            <div>
                <h2 id="mmb-phone-component-display-phone-label">客戶編號</h2>            
            </div>
            <span id="mmb-password-component-display-phone-value" data-selenium="mmb-password-component-display-phone-value"><asp:Label ID="OID1" runat="server" Text="Label"></asp:Label></span>
    </div>    
    <div id="mmb-phone-component-change" data-selenium="mmb-phone-component-change">                 
    </div>    
    <div id="mmb-phone-component-otp-verification" data-selenium="mmb-phone-component-otp-verification">     
